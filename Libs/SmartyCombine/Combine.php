...
namespace GoodGin\Libs\SmartyCombine;

use GoodGin\Libs\SmartyCombine\Minify\CSSMin;
use GoodGin\Libs\SmartyCombine\Minify\JSMin;
...
class Combine
{
    ...
    public static function init(array $params)
    {
        ...
        $cache_mtime = filemtime($params['file_path'] . $cache_file_name); # Gets file modification time
