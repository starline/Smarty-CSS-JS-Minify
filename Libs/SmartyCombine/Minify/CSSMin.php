...
/*!
 * CssMin  rev 3cbf557 Jan 15, 2018
...
namespace GoodGin\Libs\SmartyCombine\Minify;
...
class CSSMin
{
    ...
    public static function minify($css = '')
    {
        ...
        $cssmin->setLinebreakPosition(1000);
     ...
     * @return string
     */
    private function processRuleBody($css)
    {
        // Process data urls
     ...
     * @return string
     */
    private function doMinify($body)
    {
        $body = trim($body);
